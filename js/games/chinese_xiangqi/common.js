...
function  abc(){  
	...
	com.getData("/js/games/chinese_xiangqi/gambit.all.js",
		function(data){
		com.gambit=data.split(" ");
		AI.historyBill = com.gambit;
	})
	com.getData("/js/games/chinese_xiangqi/store.js",
		function(data){
...
com.loadImages = function(stype){
	...
	//��������
	com.bgImg = new Image();
	com.bgImg.src  = "/img/games/chinese_xiangqi/"+stype+"/bg.png";
	
	//��ʾ��
	com.dotImg = new Image();
	com.dotImg.src  = "/img/games/chinese_xiangqi/"+stype+"/dot.png";
	
	//����
	for (var i in com.args){
		com[i] = {};
		com[i].img = new Image();
		com[i].img.src = "/img/games/chinese_xiangqi/"+stype+"/"+ com.args[i].img +".png";
	}
	
	//�������
	com.paneImg = new Image();
	com.paneImg.src  = "/img/games/chinese_xiangqi/"+stype+"/r_box.png";
	
	document.getElementsByTagName("body")[0].style.background= "url(/img/games/chinese_xiangqi/"+stype+"/bg.jpg)";
