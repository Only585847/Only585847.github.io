...
MENU_IMAGE.src = "/img/games/坦克大战/menu.gif";
var RESOURCE_IMAGE = new Image();
RESOURCE_IMAGE.src = "/img/games/坦克大战/tankAll.gif";
...
/**************声音资源*****************/
var START_AUDIO = new Audio("/audio/坦克大战/start.mp3");
var BULLET_DESTROY_AUDIO = new Audio("/audio/坦克大战/bulletCrack.mp3");
var TANK_DESTROY_AUDIO = new Audio("/audio/坦克大战/tankCrack.mp3");
var PLAYER_DESTROY_AUDIO = new Audio("/audio/坦克大战/playerCrack.mp3");
var MOVE_AUDIO = new Audio("/audio/坦克大战/move.mp3");
var ATTACK_AUDIO = new Audio("/audio/坦克大战/attack.mp3");
var PROP_AUDIO = new Audio("/audio/坦克大战/prop.mp3");
